...
typedef struct CVodeMemRec {
  ...
  void (*cv_lreinit)(struct CVodeMemRec *cvode_mem);

  void (*cv_lfreeglobal)(struct CVodeMemRec *cvode_mem);
...
SUNDIALS_EXPORT void cvErrHandler(int error_code, const char *module, const char *function, 
								  char *msg, void *data);
