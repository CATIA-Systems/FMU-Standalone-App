...
/**
* Initializes SuperLU linear solver. Should be called at first during the first doStep.
* The delayed call is needed due to a bug in SUNDIALS memory handling for SuperLU.
*/
