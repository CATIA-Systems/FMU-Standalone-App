/*
	Internal macro definitions for generated embedded code (embedded implementation of 'dsutil.h' and 'moutil.c').
*/
...
#define compile_time_assert_3(c, l) \
	typedef char static_assertion_at_line_##l[(!!(c))*2-1]
#define compile_time_assert_2(c, l) \
	compile_time_assert_3(c, l)
#define compile_time_assert(c, m) \
	compile_time_assert_2(c, __LINE__)
#ifdef __STDC_VERSION__
	#if __STDC_VERSION__ >= 201112L
		/* C11 supported */
		#define compile_time_assert(c, m) \
			_Static_assert(c, m)
		#undef compile_time_assert_2
		#undef compile_time_assert_3
	#endif
#endif

#ifdef inline_embedded
	compile_time_assert(0, "Macro error: 'inline_embedded' already defined.");
#else
...
#define homotopy(a, b) \
	(a)
#define Greater(a, b, c, d, e) \
	((a) > (c))
#define GreaterS(a, b, c, d, e) \
	(Greater(a, b, c, d, e))
#define Less(a, b, c, d, e) \
	((a) < (c))
#define LessS(a, b, c, d, e) \
	(Less(a, b, c, d, e))
#define LessEqual(x, sx, y, sy, nr) \
	((x) <= (y))
...
/* External LU-solver interface for linear systems of equations */
	...
	compile_time_assert(0, "LU-solver configuration error: LU-solver already defined.");
#endif
...
#define RosenBrockSolver1(n, s) \
	compile_time_assert(0, "Rosenbrock methods error: no LU-solver defined.");
...
#ifndef Time
	#define Time \
		([]{compile_time_assert(0, "Time configuration error: no 'time' defined by embedded environment.");}, 0)
#endif
