...
{	
	...
	/* TODO: why is it not sufficient to close delay buffers in fmiFreeModelInstance_ ? */
	/* if called also here, the reference count handling of external objects needs to be modified to deal with this */
#if 0
    if (comp->did) {
