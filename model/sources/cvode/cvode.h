...
/*
Added by Hans Olsson, Dassault Systemes
For Step events. The function is called if no normal root is found and should return 1 if a step-event occured on the last step
*/
typedef int (*CVStepRootFn)(void*user_data);
